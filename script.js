...
const translations = {
  "zh-Hant": {
    ...
    "hero-scroll": "下滑了解更多",
    "hero-btn-portfolio": "查看作品集",
    "hero-btn-resume": "下載履歷",
    ...
    "github-title": "GitHub 專案",
    "github-desc": "查看我的程式專案、網站作品與持續學習紀錄。",
    "github-button": "前往 GitHub →",
    ...
    "resume-title": "履歷下載",
    "resume-desc": "想更快速了解我的學歷、工作經驗、專案成果與技能嗎？歡迎下載我的完整履歷。",
  ...
  "en": {
    ...
    "stat-cert": "Certificates",
    "stat-exp": "Industry Experiences",
    "stat-project": "Graduation Project",
    "stat-lang": "Languages",
    ...
    "about-subtitle": "I'm Guanyu Chen, currently studying Information Management at Chinese Culture University.",
    "about-skill": "Skill & Experience",
    ...
    "edu2-title": "Chinese Culture University – Information Management",
    "edu2-desc": "Majored in system analysis, frontend development, AI applications, and business management.",
    "edu3-title": "Chinese Culture University – Graduate Institute of Information Management",
    "edu3-desc": "Continuing graduate studies in information technology research methods and digital transformation.",
    ...
    "proj1-title": "📌 Project: SoGood Stock Saving Platform (2023/9 ~ 2024/11)",
    "proj1-desc": "Responsible for content writing and frontend/MVC structure design in the graduation project.",
    ...
    "github-desc": "Explore my repositories, website projects, and ongoing learning records.",
    "github-button": "View GitHub →",

    "future-title": "Future Outlook",
    "future1-title": "Software QA",
    "future1-desc": "Continue improving test case design, bug tracking, regression testing, and quality mindset.",
    "future2-title": "Automation Testing",
    "future2-desc": "Learn to integrate AI and automation tools into testing workflows.",
    "future3-title": "Product Development Understanding",
    "future3-desc": "Understand product requirements, user flows, and feature validation from a QA perspective.",
    "future4-title": "AI Tool Application",
    "future4-desc": "Use AI to assist data organization, code understanding, website adjustment, and workflow optimization.",
    "future5-title": "Data & System Thinking",
    "future5-desc": "Strengthen database, system analysis, and process improvement abilities.",
    "future6-title": "Long-term Career Growth",
    "future6-desc": "Start from QA and grow toward automation testing, product development, and technical management.",

    "whyme-title": "Why Me?",
    "whyme-1": "✓ QA Testing Experience",
    "whyme-2": "✓ AI Annotation Experience",
    "whyme-3": "✓ Information Management Background",
    "whyme-4": "✓ AI-assisted Development Workflow",
    "whyme-5": "✓ Continuous Learning Mindset",

    "resume-title": "Resume Download",
    "resume-desc": "Download my resume PDF to quickly review my education, experience, projects, and skills.",
    "resume-button": "Download PDF Resume",
  ...
  "ja": {
    ...
    "hero-btn-portfolio": "作品集を見る",
    "hero-btn-resume": "履歴書をダウンロード",
    "hero-btn-contact": "連絡する",
    "stat-cert": "専門資格",
    "stat-exp": "業界経験",
    "stat-project": "卒業プロジェクト",
    "stat-lang": "言語対応",

    "career-title": "キャリア目標",
    "career-desc": "現在、中国文化大学大学院 情報管理研究科に在学中です。ソフトウェアテスト、Web調整、AIアノテーション、情報システムプロジェクトの経験を活かし、Software QA、自動化テスト、プロダクト開発の方向で成長したいと考えています。",
    "career-tag1": "Software QA",
    "career-tag2": "Automation Testing",
    "career-tag3": "AI支援開発",
    "career-tag4": "プロダクト開発",

    "skills-title": "スキルと技術ツール",
    "skills-subtitle": "求職向けに、現在持つ能力と強化中のスキルを整理しました。",
    "skill-testing-title": "ソフトウェアテスト",
    "skill-testing-list": "Manual Testing、Postman、Sikuli、Test Case Writing、Bug Tracking",
    "skill-frontend-title": "Web実装経験",
    "skill-frontend-list": "HTML5、CSS3、JavaScript、ASP.NET MVC、Responsive Design",
    "skill-backend-title": "バックエンドとDB",
    "skill-backend-list": "C#、MS SQL、Database Design、MVC Architecture",
    "skill-tools-title": "ツールとワークフロー",
    "skill-tools-list": "Git、GitHub、VS Code、Visual Studio、AI-assisted Workflow",
    "skill-ai-title": "AIとデータ",
    "skill-ai-list": "Image Annotation、Dataset Processing、Machine Learning Data、AI Tool Application",

    "about-title": "私について",
    "about-subtitle": "私はチェン・グァンユーで、中国文化大学の情報管理学科に在学中です。",
    "about-skill": "スキルと経験",
    "about-fe": "Web実装：HTML、CSS、JavaScript、ASP.NET MVCのプロジェクト経験があり、AIツールを活用してWeb構成、レイアウト調整、機能統合を行っています。",
    "about-qa": "ソフトウェアテスト：現在、レインボーテック社のテストエンジニアインターンとして、手動テスト、自動化テスト、Postman、Sikuliを学習中。",
    "about-ai": "AI技術：以前、Berry AIでAIアノテーターとして、画像処理、データアノテーション、機械学習データ整理を担当しました。",
    ...
    "edu3-title": "中国文化大学 大学院 情報管理研究科（在学中）",
    "edu3-desc": "情報技術の研究方法とデジタル変革を学習中。",
    ...
    "portfolio-title": "作品集",
    "proj1-title": "📌 プロジェクト：SoGood貯株プラットフォーム (2023/9 ~ 2024/11)",
    "proj1-desc": "卒業プロジェクトでコピーライティングとフロントエンド/MVC構成設計を担当。",
    "proj1-link": "🔗 ウェブサイト",
    "proj1-video": "▶️ 動画を見る",
    ...
    "github-title": "GitHubプロジェクト",
    "github-desc": "リポジトリ、Web作品、継続的な学習記録をご覧ください。",
    "github-button": "GitHubを見る →",

    "future-title": "今後の展望",
    "future1-title": "Software QA",
    "future1-desc": "テストケース設計、バグ追跡、回帰テスト、品質思考を強化します。",
    "future2-title": "自動化テスト",
    "future2-desc": "AIと自動化ツールをテストワークフローに活用する方法を学びます。",
    "future3-title": "プロダクト理解",
    "future3-desc": "QA視点から要件、ユーザーフロー、機能検証を理解します。",
    "future4-title": "AIツール活用",
    "future4-desc": "AIを活用し、資料整理、コード理解、Web調整、業務効率化を進めます。",
    "future5-title": "データとシステム思考",
    "future5-desc": "データベース、システム分析、プロセス改善能力を強化します。",
    "future6-title": "長期キャリア成長",
    "future6-desc": "QAを起点に、自動化テスト、プロダクト開発、技術管理へ成長します。",

    "whyme-title": "なぜ私なのか？",
    "whyme-1": "✓ ソフトウェアテスト経験",
    "whyme-2": "✓ AIアノテーション経験",
    "whyme-3": "✓ 情報管理の専門知識",
    "whyme-4": "✓ AI支援開発ワークフロー",
    "whyme-5": "✓ 継続的な学習姿勢",

    "resume-title": "履歴書ダウンロード",
    "resume-desc": "学歴、職務経験、プロジェクト、スキルについて詳しく知りたい方は履歴書をご覧ください。",
    "resume-button": "PDF履歴書をダウンロード",
...
function initTiltCards() {
  if (window.matchMedia("(pointer: coarse)").matches) return;
  document.querySelectorAll(".project, .image-item, .timeline-content, .skill-card").forEach(card => {
