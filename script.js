...
const translations = {
  "zh-Hant": {
    ...
    "hero-role": "我是",
    "hero-desc": "專注於網頁前端與網頁開發、軟體測試、AI技術、數據分析與ESG永續經營理念",
    "hero-scroll": "下滑了解更多",
    ...
    "about-fe": "前端開發：具有 2~3 年的開發與專案經驗，熟悉 ASP.NET MVC、C#、JavaScript、HTML5 等。",
    "about-qa": "遊戲測試：目前為馬紹爾群島商彩虹科技公司測試實習生，學習手動測試與自動化測試(Postman.Sukuli)工具應用。",
    "about-ai": "AI 技術：曾任職 Berry AI 團隊的 AI 標註師，負責圖像處理與機器學習統計等相關專案。",
  ...
  "en": {
    ...
    "about-skill": "Skill & Experience",
    "about-fe": "Frontend Development: 2-3 years of experience with ASP.NET MVC, C#, JavaScript, HTML5, etc.",
    "about-qa": "Game Testing: Test Engineer Intern at Rainbow Tech, learning manual and automated testing (Postman, Sukuli).",
    "about-ai": "AI Tech: Former AI Annotator at Berry AI, handling image processing and machine learning datasets.",
    ...
    "edu3-title": "Chinese Culture University – Graduate School (Planned)",
    "edu3-desc": "Planning to pursue graduate studies focusing on IT research methods and integrating self-media marketing with IT transformation.",

    "exp-title": "Experience",
    "exp1-company": "Company: Rainbow Tech (Marshall Islands)",
    "exp1-role": "Test Engineer Intern",
    "exp1-desc": "Internship focused on testing new features, regression testing, automated testing, writing test cases, and database data modification testing for the company's gaming products.",
  ...
  "ja": {
    ...
    "about-skill": "スキルと経験",
    "about-fe": "フロントエンド開発：2〜3年の開発とプロジェクト経験があり、ASP.NET MVC、C#、JavaScript、HTML5 などに精通しています。",
    "about-qa": "ゲームテスト：現在、レインボーテック社のテストエンジニアインターンとして、手動および自動化テスト（Postman、Sukuli）を学習中。",
    "about-ai": "AI 技術：以前、Berry AI チームの AI アノテーターとして、画像処理と機械学習データセットを担当しました。",
    ...
    "edu3-desc": "情報技術の研究方法とセルフメディアマーケティングをIT変革と統合するために、大学院での研究を計画しています。",

    "exp-title": "職務経歴",
    "exp1-company": "会社名: レインボーテック（マーシャル諸島）",
    "exp1-role": "テストエンジニアインターン",
    "exp1-desc": "インターンシップでは、同社のゲーム製品の新機能テスト、回帰テスト、自動化テスト、テストケースの作成、データベースデータの変更テストに重点を置いています。",
